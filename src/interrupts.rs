...
use spin;
use x86_64::structures::idt::{DivergingHandlerFunc, InterruptDescriptorTable, InterruptStackFrame};
...
extern "x86-interrupt" fn keyboard_interrupt_handler(_stack_frame: InterruptStackFrame)
{
    ...
    lazy_static! {
        static ref KEYBOARD: Mutex<Keyboard<layouts::Dvorak104Key, ScancodeSet1>> =
            Mutex::new(Keyboard::new(layouts::Dvorak104Key, ScancodeSet1,
...
unsafe fn clear_interrupt(_which: InterruptIndex) {
    PICS.lock().notify_end_of_interrupt(_which.as_u8());
}
